...
export default function PrivacyPolicyPage() {
  ...
  return (
    <>
      <SEOHead title={t("Privacy Policy | Dent Master Franchise", "Política de Privacidad | Dent Master Franchise")} description={t("Privacy policy for Dent Master Franchise.", "Política de privacidad de Dent Master Franchise.")} path="/privacy-policy" />
      <section className="section-padding bg-background">
        <div className="section-container max-w-3xl">
          <h1 className="text-3xl font-bold text-foreground mb-8 font-heading">{t("Privacy Policy", "Política de Privacidad")}</h1>
