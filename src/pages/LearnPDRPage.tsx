    ...
    <>
      ...
      <section className="bg-charcoal">
        <div className="section-container py-16 md:py-24">
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-4 font-heading">Learn Paintless Dent Repair</h1>
          <p className="text-lg text-white/70 max-w-3xl">Hands-on, in-person PDR training in Orlando, FL. No experience required. Start your career in one of the fastest-growing automotive repair fields.</p>
        </div>
      </section>
        ...
        <div className="section-container max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            {TRAINING_PRICING.map((tier, i) => (
              <div key={tier.label} className={`card-elevated text-center ${i === 2 ? "border-primary ring-2 ring-primary/20" : ""}`}>
