...
export default function AboutPage() {
  ...
  return (
    <>
      <SEOHead
        title={t("Leading Trusted PDR Experts — About Dent Master Franchise Orlando, FL", "Expertos PDR de Confianza — Sobre Dent Master Franchise Orlando, FL")}
        description={t("Learn about Dent Master Franchise, Orlando's most trusted paintless dent repair company.", "Conozca a Dent Master Franchise, la empresa de reparación sin pintura más confiable de Orlando.")}
        path="/about"
      />
      <LocalBusinessJsonLd />
      ...
      <section className="bg-charcoal">
        <div className="section-container py-16 md:py-24" ref={heroRef}>
          <h1 className="hero-anim text-3xl md:text-5xl font-bold text-white mb-4 font-heading">
            {t("About Dent Master Franchise", "Sobre Dent Master Franchise")}
          </h1>
          <p className="hero-anim text-lg text-white/70 max-w-3xl">
            {t("Orlando's most trusted paintless dent repair company — delivering flawless results with certified expertise and honest, transparent pricing.", "La empresa de reparación de abolladuras sin pintura más confiable de Orlando — resultados impecables con experiencia certificada y precios honestos.")}
          </p>
        </div>
      </section>
      ...
      <article className="section-padding bg-background">
        <div className="section-container max-w-4xl" ref={contentRef}>
          ...
          <div className="content-section bg-accent/50 rounded-xl p-6 mb-12 hover:shadow-lg transition-shadow duration-300">
            ...
            <Link to="/dealerships-fleet" className="text-sm font-semibold text-primary mt-3 inline-block hover:underline">{t("Learn about fleet services →", "Conozca nuestros servicios para flotas →")}</Link>
          </div>
