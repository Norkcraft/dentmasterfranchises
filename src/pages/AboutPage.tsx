    ...
    <>
      ...
      <section className="bg-charcoal">
        <div className="section-container py-16 md:py-24">
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-4 font-heading">About Dent Master Franchise</h1>
          <p className="text-lg text-white/70 max-w-3xl">Orlando's most trusted paintless dent repair company — delivering flawless results with certified expertise and honest, transparent pricing.</p>
        </div>
      </section>
