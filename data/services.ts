...
export const services: ServiceData[] = [
  {
    ...
    metaTitle: "Paintless Dent Repair Orlando — No Repaint | Dent Master",
    metaDescription: fitMetaDescription(
      "Paintless dent repair Orlando for door dings, hail dents, and body damage without repainting. We protect factory paint, move fast, and quote from photos."
    ),
    h1: "Restore Your Car With Paintless Dent Repair Orlando",
    h1Es: "Reparación de Abolladuras sin Pintura en Orlando, FL",
    heroDescription: "Paintless dent repair Orlando restores your factory finish without repainting. Send photos and get a clear quote fast.",
    ...
    faqs: [
      ...
      { q: "What's the best paintless dent repair service in Orlando Florida?", a: "Dent Master Franchise is a trusted paintless dent repair team serving Orlando and Central Florida. We offer mobile service when conditions allow, work with insurance, and stand behind our repairs." },
      { q: "Can you fix door dings and parking lot dents in Orlando?", a: "Absolutely. We remove parking lot door dings throughout Orlando using paintless dent repair when the paint is intact. Many door ding repairs can be completed quickly, and we’ll confirm timing after a photo review." },
      { q: "Do you offer mobile paintless dent repair in Orlando FL?", a: "Yes. Our mobile PDR service covers Orlando and many surrounding areas. We can often come to your home, office, or another convenient location when conditions support a clean repair." },
      { q: "How much does PDR cost for hail damage in Orlando?", a: "Hail damage pricing depends on the number of dents, panel access, and severity. Send photos for a fast estimate, and we can help you understand what insurance may cover." },
      { q: "Can PDR fix creases and sharp dents in Orlando?", a: "Yes, our certified technicians can repair most creases and sharp dents using advanced PDR techniques. Severe creases may require traditional body work - we'll assess and recommend the best approach." }
    ],
    faqsEs: [
  ...
  },
  {
    ...
    metaTitle: "Hail Damage Repair Orlando — Insurance Help | Dent Master",
    metaDescription: fitMetaDescription(
      "Hail damage repair Orlando that removes storm dents without repainting. We document damage, work with insurance, and restore panels fast."
    ),
    h1: "Fix Storm Dents With Hail Damage Repair Orlando",
    h1Es: "Reparación de Daños por Granizo en Orlando, FL",
    heroDescription: "Hail damage repair Orlando removes storm dents without repainting. We map every dent and guide you through the claim.",
  ...
  },
  {
    ...
    metaTitle: "Door Ding Removal Orlando — Mobile Repair | Dent Master",
    metaDescription: fitMetaDescription(
      "Door ding removal Orlando that fixes parking lot dents without repainting. We repair at your home or office, protect factory paint, and quote from photos."
    ),
    h1: "Fix Door Dings With Mobile Dent Removal Orlando",
    h1Es: "Eliminación de Abolladuras Menores en Orlando, FL",
    heroDescription: "Door ding removal Orlando keeps your car looking new without repainting. We fix most dents fast and keep pricing clear.",
  ...
  },
  {
    ...
    metaTitle: "Collision Dent Repair Orlando — No Paint | Dent Master",
    metaDescription: fitMetaDescription(
      "Collision dent repair Orlando that fixes minor impacts without repainting. We assess damage fast, explain options clearly, and help with insurance."
    ),
    h1: "Fix Minor Impacts With Collision Dent Repair Orlando",
    h1Es: "Reparación de Colisión Basada en PDR en Orlando, FL",
    heroDescription: "Collision dent repair Orlando fixes many impacts without repainting. We keep factory paint, move fast, and make the next step clear.",
  ...
  },
  {
    ...
    metaTitle: "Fender Dent Repair Orlando — No Paint | Dent Master",
    metaDescription: fitMetaDescription(
      "Fender dent repair Orlando that restores creased fenders without repainting. We preserve body lines, protect factory paint, and quote from photos."
    ),
    h1: "Restore Body Lines With Fender Dent Repair Orlando",
    h1Es: "Reparación de Guardafangos en Orlando, FL",
    heroDescription: "Fender dent repair Orlando restores curves and body lines without repainting. We keep factory paint and get you back on the road fast.",
